  ...
  <div class="section-content flex flex-wrap justify-around">
    ...
    <div class="section-second flex w-full h-370px mb-2.5 ">
      ...
      <img
        ...
        src="../../assets/img/undraw_job_offers_kw5d@2x.png"
        width="180px"
        height="127px"
        alt=""
      />
      <p class="section-second-num h-40 mt-2.5 font-lato text-130px text-first tracking-normal absolute">2.</p>
      <p class="section-second-text absolute font-lato text-first text-base tracking-0.47px mt-28 pr-4 ">Erhalte Vermittlungs- angebot von Arbeitgeber</p>
    </div>
    <div class="section-third flex w-full h-250px mb-48">
      <img
        class="section-third-logo absolute mt-120px"
        src="../../assets/img/undraw_business_deal_cpi9@2x.png"
        width="250px"
        height="189px"
        alt=""
      />
      <p class="section-third-num h-40 -mt-40px font-lato text-130px text-first tracking-normal absolute">3.</p>
      <p class="section-third-text absolute font-lato text-first text-base tracking-0.47px mt-22px ">Vermittlung nach Provision oder Stundenlohn</p>
    </div>
  </div>
</template>
<template>
  <div class="section-content flex flex-wrap justify-around">
    <div class="section-title flex justify-around flex-wrap flex-col tracking-normal text-21px text-third font-lato font-medium">
      ...
      <p class="h-6"> zu deinem neuen Mitarbeiter </p>
    </div>
    <div class="section-first flex w-full h-250px -mb-2.5	">
      ...
      <p class="section-first-text absolute font-lato text-first text-base tracking-0.47px pr-8 mt-182px ">Erstellen dein Unternehmensprofil</p>
    </div>
    <div class="section-second flex w-full h-370px mb-2.5 ">
      ...
      <img
        ...
        src="../../assets/img/undraw_about_me_wa29@2x.png"
        width="180px"
        height="127px"
        alt=""
      />
      <p class="section-second-num h-40 mt-2.5 font-lato text-130px text-first tracking-normal absolute">2.</p>
      <p class="section-second-text absolute font-lato text-first text-base tracking-0.47px mt-140px ">Erstellen ein Jobinserat</p>
    </div>
    <div class="section-third flex w-full h-250px mb-48">
      <img
        class="section-third-logo absolute mt-32"
        src="../../assets/img/undraw_swipe_profiles1_i6mr@2x.png"
        width="240px"
        height="197px"
        alt=""
      />
      <p class="section-third-num h-40 -mt-40px font-lato text-130px text-first tracking-normal absolute">3.</p>
      <p class="section-third-text absolute font-lato text-first text-base tracking-0.47px mt-9 ">Wähle deinen neuen Mitarbeiter aus</p>
    </div>
  </div>
</template>